...
export function CtaBanner() {
  return (
    <section className="bg-[color:var(--color-charcoal)] py-20 text-white">
      <PageShell>
        <div className="overflow-hidden rounded-[2.5rem] border border-white/10 bg-[linear-gradient(135deg,rgba(198,40,40,0.92),rgba(217,119,6,0.9),rgba(17,17,17,0.85))] px-8 py-10 shadow-[0_30px_80px_rgba(17,17,17,0.25)] sm:px-12 sm:py-14">
